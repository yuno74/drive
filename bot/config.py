class config:
    BOT_TOKEN = "1637870782:AAFlkHmxLCKNCu2VSj6DbUdVn8SmEaJWaUw"
    APP_ID = "2743279"
    API_HASH = "5eb0b49fbc3a6355feffd2f2bee2187f"
    DATABASE_URL = "postgres://drive:123@0.0.0.0:5432/bot"
    SUDO_USERS = "" # Sepearted by space.
    SUPPORT_CHAT_LINK = "https://t.me/AnimeChat74"
    DOWNLOAD_DIRECTORY = "./downloads/"
    G_DRIVE_CLIENT_ID = "606946955414-aon9bk3om18subb863fdlfgcit0qb6uq.apps.googleusercontent.com"
    G_DRIVE_CLIENT_SECRET = "jKew5ELCps-hWbBdGNiUmnaC"
...
class Messages:
    ...
    HELP_MSG = [
        ...
        f"**Direct Links**\n__Send me a direct download link for a file and i will download it on my server and Upload it to your Google Drive Account. You can rename files before uploading to GDrive Account. Just send me the URL and new filename separated by ' | '.__\n\n**__Examples:__**\n```https://example.com/example.mkv | New FileName.mkv```\n\n**Telegram Files**\n__To Upload telegram files in your Google drive Account just send me the file and i will download and upload it to your Google Drive Account. Note: Telegram Files Downloading are slow. it may take longer for big files.",
        ...
        "**Rules & Precautions**\n__1. Don't copy BIG Google Drive Files/Folders. It may hang the bot and your files maybe damaged.\n2. Send One request at a time unless bot will stop all processes.\n3. Don't misuse, overload or abuse this free service.__",
